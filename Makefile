...
# IMAGE_BUILDER defines which image builder will be used [docker,podman]
...
IMAGE_TAG_BASE ?= $(IMAGE_REPO)/prismacloud/pcc-operator
...
docker-build: ## Build docker image with the manager.
	$(IMAGE_BUILDER) build -t ${IMG} --build-arg VERSION=v$(VERSION) . 
